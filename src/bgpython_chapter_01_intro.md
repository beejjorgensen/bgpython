...
Beej's Guide to Python is Copyright © 2019 Brian "Beej Jorgensen" Hall.
...
The Python source code presented in this document is hereby granted to
...
guide written. And thank you to all the people who produce the Free software and
packages that I use to make the Guide: GNU, Linux, Slackware, vim, Python,
Inkscape, pandoc, many others. And finally a big thank-you to the literally
thousands of you who have written in with suggestions for improvements and words
of encouragement.
