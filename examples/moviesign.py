...
movies = [
    ...
    Movie("Shawn of the Dead", 100, "romzomcom"),
    Movie("The World's Fastest Indian", 127, "drama")
]
...
# McMenamin's is showing Star Wars and Shawn of the Dead
theaters[0].movies.append(movies[0])
theaters[0].movies.append(movies[1])

# Tin Pan is showing Shawn of the Dead and Fastest Indian
